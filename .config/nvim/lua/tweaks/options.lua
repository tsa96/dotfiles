-- derived from https://github.dev/loctvl842/nvim/blob/master/lua/beastvim/init.lua
...
opt.scrolloff = 4                  -- https://vim.fandom.com/wiki/Keep_your_cursor_centered_vertically_on_the_screen
opt.sidescrolloff = 8
opt.laststatus = 3
